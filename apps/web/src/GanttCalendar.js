...
export const GanttCalendar = ({ slots, onSlotUpdate }) => {
    ...
    if (slots.length === 0) {
        return (_jsx("div", { style: { padding: "20px", textAlign: "center", color: "#94a3b8" }, children: "Aucun cr\u00E9neau \u00E0 afficher" }));
    }
    ...
    const getSlotPosition = (startAt, endAt) => {
    ...
    const handleMouseDown = (event, slotId, edge) => {
    ...
    const handleMouseMove = (event) => {
        ...
        if (draggedSlotId) {
            ...
            onSlotUpdate(draggedSlotId, newStart.toISOString().slice(0, 16), newEnd.toISOString().slice(0, 16));
        }
        ...
        while (current <= dayEnd) {
            ...
            markers.push(_jsx("div", { style: {
                    ...
                    width: "1px"
                        ...
                        width: "40px",
                        textAlign: "center"
                    }, children: current.toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" }) }) }, current.toISOString()));
    ...
    return (_jsx("div", { style: {
        ...
        }, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseLeave: handleMouseUp, children: _jsxs("div", { style: {
                position: "relative",
                height: `${sortedSlots.length * 60 + 40}px`,
                width: `${timelineWidth}px`,
                minWidth: "100%"
            }, children: [generateTimeMarkers(), sortedSlots.map((slot, index) => {
                    ...
                    return (_jsxs("div", { style: {
                            ...
                            overflow: "hidden",
                            userSelect: "none"
                        }, onMouseDown: (e) => handleMouseDown(e, slot.id, "move"), children: [_jsx("div", { style: { fontSize: "12px", fontWeight: "bold", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: slot.title }), _jsxs("div", { style: { fontSize: "10px", opacity: 0.9 }, children: [new Date(slot.startAt).toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" }), " -", " ", new Date(slot.endAt).toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" })] }), _jsx("div", { style: {
                                    position: "absolute",
                                    left: 0,
                                    top: 0,
                                    bottom: 0,
