...
import { AuditPocPage } from "./pages/AuditPocPage";
...
export function RootApp() {
    ...
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsxs(ChakraProvider, { theme: theme, children: [_jsx(ColorModeScript, { initialColorMode: theme.config.initialColorMode }), _jsx(HashRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(CampaignSelectionPage, { onCampaignChange: setCampaignId }) }), _jsx(Route, { path: "/administration", element: _jsx(AdministrationPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/*", element: _jsx(AppLayout, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/organisation", element: _jsx(PreliminairePage, { campaignId: campaignId, onCampaignChange: setCampaignId }) }), _jsx(Route, { path: "/preliminaire", element: _jsx(Navigate, { to: "/organisation", replace: true }) }), _jsx(Route, { path: "/preparation", element: _jsx(PreparationPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/analyse-documentaire", element: _jsx(AnalyseDocumentairePage, { campaignId: campaignId }) }), _jsx(Route, { path: "/document-registry", element: _jsx(DocumentRegistryPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/document-registry/:id", element: _jsx(DocumentDetailPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/audit-poc", element: _jsx(AuditPocPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/entretiens", element: _jsx(EntretiensPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/redaction", element: _jsx(RedactionPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/parametrage", element: _jsx(ParametragePage, { campaignId: campaignId }) }), _jsx(Route, { path: "/administration", element: _jsx(AdministrationPage, { campaignId: campaignId }) }), _jsx(Route, { path: "/legacy-workspace", element: _jsx(LegacyWorkspacePage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }) })] }) })] }) }));
}
