...
export function App() {
    ...
    return (_jsxs("main", { className: "page", children: [_jsx("h1", { children: "Rubis - MVP Audit" }), _jsx("p", { children: "Phase 1.1: pr\u00E9paration des entretiens et g\u00E9n\u00E9ration de questions." }), _jsxs("div", { className: "view-switch", children: [_jsx("button", { type: "button", onClick: () => setViewMode("workspace"), children: "Mode Saisie" }), _jsx("button", { type: "button", onClick: () => {
                        ...
                        }, children: "Mode Dashboard" }), _jsx("button", { type: "button", onClick: () => setViewMode("roadmap"), children: "\uD83D\uDCCA Roadmap" })] }), errorMessage ? _jsx("p", { className: "status-error", children: errorMessage }) : null, viewMode === "dashboard" ? (_jsxs(_Fragment, { children: [_jsxs("section", { className: "card", children: [_jsx("h2", { children: "Dashboard campagne" }), _jsxs("p", { children: ["ID campagne: ", campaignId || "-"] }), _jsxs("form", { onSubmit: (event) => {
                                    event.preventDefault();
                                    void loadDashboardData();
